...
Then the request is routed to `http://localhost:11434/v1/chat/completions` using the model configured in `OLLAMA_MODEL` (e.g., `gpt-oss:20b`) without requiring real API key authentication.
